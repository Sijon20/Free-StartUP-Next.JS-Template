...
const ProfileMenu = ({handleSubmenu,openIndex,profilename}) => {
    return <>
    <div>
    ...
    <div key={menuItem.id} className="group relative">
      {menuItem.path ? (
        ...
        <>
          ...
          >
            <CgProfile className="font-extrabold text-xl mr-1"/><div className=" flex text-base justify-center font-medium">{profilename}</div>
            <span className="pl-3">
...
const Navmenu = ({openIndex,handleSubmenu}) => {
  return <>
