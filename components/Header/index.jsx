            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div>
                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                   <Navmenu openIndex={openIndex} handleSubmenu={handleSubmenu} />
                  </ul>
                </nav>
              </div>
              {/* Header Submenue End -------> */}
             ...
             {isAuthenticated ? (
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <div className="hidden py-3 px-7 text-base font-bold text-dark hover:opacity-70 dark:text-white md:block">
                  <ProfileMenu openIndex={openIndex} profilename={profile.name} handleSubmenu={handleSubmenu} />
                </div>
                <div>
                  <ThemeToggler />
                </div>
