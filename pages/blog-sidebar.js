...
const richText = `A paragraph with *emphasis* and **strong importance**.
...
const BlogSliderdata = [
  {
    ...
    metadescription:"Lore ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    ...
    tag: "Design",
    relatedtag: ["Design", "Development", "Marketing"],
    totalcoment:50,
    totalviews: 35,
    coments:[
      {
        ...
        date:"12 Jan 2024",
        coment:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
      },
    ]
  },
];
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src={BlogSliderdata[0].authorimage}
                            alt="author"
                            fill
                          />
                        </div>
                      ...
                      <div className="w-full">
                        <h4 className="mb-1 text-base font-medium text-body-color">
                          By
                          <span> {BlogSliderdata[0].author}</span>
                        </h4>
                      </div>
                    </div>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        {BlogSliderdata[0].relatedtag.map((item, index) => (
                          <TagButton text={item} key={index} />
                        ))}
                      </div>
                    </div>
                    <div className="mb-5">
